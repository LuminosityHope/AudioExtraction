...
protected:
    virtual void SetUp(void)  {
        ...
        std::vector<float> goodData = { 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f };
        CreateTestFile("good_file.bin", goodData);

        std::vector<float> badData = { 1.0f, 2.0f, 3.0f }; 
        CreateTestFile("bad_file.bin", badData);
    }
